package de.ananyev.fpla.config;
...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "fpla@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "fpla API";

        private String description = "fpla API documentation";
